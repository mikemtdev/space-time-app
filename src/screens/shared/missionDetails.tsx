...
import { Box, FlatList, HStack, Link, ScrollView, Text } from 'native-base';
 ...
 return (
  <ScrollView my={4}>
   <Box mx="3">
    ...
    <Box mt={2} borderWidth={2} px={3} borderColor="warmGray.200" py={2} mb={2}>
      ...
      }) => {
       {
        item?.customers[0] ? (
         <Box>
          ...
          <Text>{item?.reused ? 'true' : null}</Text>
         </Box>
        ) : null;
       }
      }}
